...
public class searchCategoryBakeryResults extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_category_bakery_results);
    ...
    public void onStart() {
        super.onStart();
        allItems = db.getItemsForBakery();
        ArrayAdapter itemListArrayAdapter = new ArrayAdapter <String> (searchCategoryBakeryResults.this, android.R.layout.simple_list_item_1, allItems);
